    ...
    <>
      <header>
        <nav className="bg-red-500 py-5 px-5 flex items-center space-x-4 justify-between">
          <div className="flex justify-evenly space-x-10 items-center">
            <div className="logo">
              <h1 className="text-white text-2xl font-bold lg:3xl hover:cursor-pointer">
                Kalvium
              </h1>
            </div>
            <div>
          ...
          <button className="py-1 bg-transparent px-4 border-white border-[1px] bg-[#000000] rounded-md text-white">
            Login
          </button>
        </nav>
      </header>
      ...
      <main className="py-5">
        <section className="px-[9.2rem]">
          <button className=" rounded-md p-2 text-white font-bold bg-blue-600 mb-5">
            Button One
          </button>
          <div
          ...
          >
            ...
            <span className="font-medium">kore wa</span>
            <span className="font-semibold"> yasashi desu!</span>
          </div>
        </section>
      ...
      <footer className="text-center bg-slate-300 p-4">
        <h2>
          &copy; 2024 Copyright:<span className="font-semibold">Kalvium</span>
        </h2>
      </footer>
    </>
  );
